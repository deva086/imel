...
urlpatterns = patterns(
    ...
    url(r'^reports/', include('onadata.apps.reports.urls', namespace="reports")),
    url(r'^merge/', include('onadata.apps.merge_report_gen.urls', namespace="merge_report_gen",app_name="merge_report_gen")),
    ...
    url(r'^(?P<username>[^/]+)/data',
        'onadata.apps.main.views.data_list'),
    ...
    url(r'^data/approval-list/$', 'onadata.apps.stats.views.data_approval_list'),
    ...
    url(r"^stats/test_pending-approval/$", 'onadata.apps.stats.views.pending_approval'),
    ...
    #url(r"^(?P<username>\w+)/forms/(?P<id_string>[^/]+)/instance/(?P<s_id>[^/]+)",
    ...
    url(r"^submission$",
        ...
        name='submissions'),
    url(r"^formList$",
        XFormListApi.as_view({'get': 'form_list'}), name='form-list'),
    ...
    url(r'^(?P<username>[^/]+)/m/login/$', 'onadata.apps.main.views.mobile_login'),
