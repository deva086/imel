...
# LOGIN_URL = KOBOCAT_URL+'/usermodule/login/'
MEDIA_URL = KOBOCAT_URL+'/media/'
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'onadata.apps.usermodule.context_processors.is_oxfambd_user'
)
...
INSTALLED_APPS = (
    ...
    'onadata.apps.reports',
    'onadata.libs',
    'onadata.apps.merge_report_gen',
